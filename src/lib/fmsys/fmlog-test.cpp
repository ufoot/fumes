...
void fmsys::log_test::runTest() {
  ...
  FMSYS_LOG_CRIT << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_crit() << TEST_LOG_MULTILINE;
  FMSYS_LOG_CRIT << TEST_LOG_MULTILINE;
  fmsys::log_error() << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  FMSYS_LOG_ERROR << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_error() << TEST_LOG_MULTILINE;
  FMSYS_LOG_ERROR << TEST_LOG_MULTILINE;
  fmsys::log_warning() << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  FMSYS_LOG_WARNING << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_warning() << TEST_LOG_MULTILINE;
  FMSYS_LOG_WARNING << TEST_LOG_MULTILINE;
  fmsys::log_notice() << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  FMSYS_LOG_NOTICE << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_notice() << TEST_LOG_MULTILINE;
  FMSYS_LOG_NOTICE << TEST_LOG_MULTILINE;
  fmsys::log_info() << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  FMSYS_LOG_INFO << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_info() << TEST_LOG_MULTILINE;
  FMSYS_LOG_INFO << TEST_LOG_MULTILINE;
  fmsys::log_debug() << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  FMSYS_LOG_DEBUG << TEST_LOG_WORD1 << TEST_LOG_WORD2;
  fmsys::log_debug() << TEST_LOG_MULTILINE;
  FMSYS_LOG_DEBUG << TEST_LOG_MULTILINE;
